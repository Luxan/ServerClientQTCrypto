...
void zero();
void initializeMessageProcessor(Certificate * certificate);
void initializeMessageCollector();
void initializeEpollTCPChannel();
void initializeDataBase();
void initializeEncryptionProcessor(Key * rsaPrivateKey);
...
void modules::initializeMessageProcessor(Certificate * certificate)
{
    ...
    modules::mp = new MessageProcessor(conf1, &controllers::mpth, 5, certificate);
...
void modules::initializeMessageCollector()
{
...
void modules::initializeEpollTCPChannel()
{
    ...
    modules::server = new EpollTCPChannel(conf3, globalConfiguration.serverPort, 64);
...
void modules::initializeDataBase()
{
    //create DataBase
...
void modules::initializeEncryptionProcessor(Key * rsaPrivateKey)
{
    ...
    modules::encr = new EncryptionProcessor(conf5, &controllers::enth, 5, rsaPrivateKey);
...
void modules::initializeDecryptionProcessor()
{
